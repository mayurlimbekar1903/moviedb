...
//            deleteBtn.topAnchor.constraint(equalTo: posterImageView.topAnchor),
    ...
    func configureCell(topRated:TopRatedResults) {
        self.titleLbl.text = topRated.title
        self.descriptionLbl.text = topRated.overview
        
        if let posterPath = topRated.poster_path {
